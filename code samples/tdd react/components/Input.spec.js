...
describe('Layout',()=>{
    ...
    it('has text type on input when type not provided as prop',()=>{
        const {container} = render(<Input/>)
        const input = container.querySelector('input')
        expect(input.type).toBe('text')
    })

    it('has password type on input when type password provided as prop',()=>{
    ...
    it('has value for input when it is provided as prop',()=>{
        const {container} = render(<Input value="value text"/>)
        const input = container.querySelector('input')
        expect(input.value).toBe('value text')
    })
    ...
    it('has default style where no validation error or success',()=>{
        const {container} = render(<Input/>)
        const input = container.querySelector('input')
